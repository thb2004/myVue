			...
			<div class="main-middle">
				<el-tabs v-model="activeName" @tab-click='tabClick'>
					<el-tab-pane label="临时借用ROOT" name="one">
						<el-form :model='oneForm' :label-width='$store.state.labelWidth' ref='oneForm' :rules='rules' :style='{"padding-right": $store.state.labelWidth}'>
							<el-row>
								<el-col :md='24'>
					...
					<el-tab-pane label="非标准主机命令执行" name="three">
						<el-form :model='threeForm' :label-width='$store.state.labelWidth' ref='threeForm' :rules='rules1' :style='{"padding-right": $store.state.labelWidth}'>
							<el-row>
								<el-col :md='24'>
								...
								<el-col :md='24' v-show='isShowCommand'>
					...
					<el-tab-pane label="文本操作" name="four">
						<el-form :model='fourForm' :label-width='$store.state.labelWidth' ref='fourForm' :rules='rules' :style='{"padding-right": $store.state.labelWidth}'>
							<el-row>
								<el-col :md='24'>
					...
					<el-tab-pane label="老机器标准化" name="six">
						<el-form :model='sixForm' :label-width='$store.state.labelWidth' ref='sixForm' :rules='rules' :style='{"padding-right": $store.state.labelWidth}'>
							<el-row>
								<el-col>
