<template>
    <div class='box'>
    	<div class="work-mange">
    		<div class='main-top'>
				<el-form :model='form' :label-width='$store.state.labelWidth' :style='{"padding-right": $store.state.labelWidth}'>
					<el-row>
						<el-col :md='12'>
				...
				<div class='btn-group-lg'>
	        		<el-button type="primary" @click="onSubmit" :disabled='queryBtnDisabled'>查 询</el-button>
    		...
    		<div class="main-middle">
	    		<v-table 
		    		:data='workMangeTableData' 
		    		:tableHeadName='workMangeTableHeadName' 
	    	...
	    	<el-dialog
	    	  ...
	    	  @close='closeRemarkDialog'>	
				...
				<div class='text-right'>
			    	<span slot="footer" class="dialog-footer">
			    	  	<el-button type="primary" @click="closeRemarkDialog">关 闭</el-button>
			    	</span>
		    	</div>
	    	</el-dialog>
    	</div>
	...
	export default {
		data () {
			return {
				...
				deptList: [],
				workMangePageSize: 10,
				workMangeTotal: 1,
				workMangeCurrentPage: 1,
				productModuleList: [],
				requestTypeList: [],
				createrList: [],
				workMangeTableData: [],
				workMangeAllTableData: [],
		        workMangeTableHeadName: {
		        	ticketNumber: '工单编号',
		            typeName: '请求类型',
		            createPerson: '创建人',
		            createTime: '创建时间',
			...
			changeTableData (type) {
				...
				app.post('/Gaea_api/getTicketlist', {
					...
					for (let i of response.data.data) {
						this.workMangeTableData.push(i)
					}
