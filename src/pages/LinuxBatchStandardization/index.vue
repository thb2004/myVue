			...
			<div class="main-middle">
				<el-tabs v-model="activeName">
					...
					<el-tab-pane label="Linux标准化" name="two">
						<el-form :model='twoForm' :label-width='$store.state.labelWidth' ref='twoForm' :rules='rules1' :style='{"padding-right": $store.state.labelWidth}'>
							<el-row>
								<el-col :md='12'>
					...
					<el-tab-pane label="修改密码" name="four">
						<el-form :model='fourForm' :label-width='$store.state.labelWidth' ref='fourForm' :rules='rules1' :style='{"padding-right": $store.state.labelWidth}'>
							<el-row>
								<el-col :md='24'>
									<el-form-item label="IP列表" prop='iplist'>
									    <el-input
